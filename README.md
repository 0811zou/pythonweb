# 智农溯源 —— 基于 Django + DRF 与大模型的农产品溯源与智能助农平台
...
**智农溯源**是一个基于 Django + DRF、融合大模型分析与二维码溯源技术的农业 Web 平台。与普通溯源平台不同，本系统在提供"从田间到餐桌"全流程追溯的同时，利用订单数据 + 大模型 API 进行市场需求分析，为农户提供销售决策支持。
